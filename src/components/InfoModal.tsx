  ...
  const pages: ModalPage[] = [
    {
      ...
      content: (
        <>
          ...
          <p className="mb-3">
            This project is Open Source, and the entire source code is publicly
            available on
            <a
          ...
          <p>
            ...
            modify, and distribute the code, as long as the license is included.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <p className="mb-3">
            To export a chat from WhatsApp without media, follow these steps:
          </p>
      ...
      content: (
        <>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              <strong>Sender Selection:</strong> Choose specific participants
              whose messages should be included.
            </li>
            <li>
              <strong>Weekday Selection:</strong> Filter messages by the days
              they were sent.
            </li>
            <li>
              <strong>Minimum Message Share:</strong> Set a threshold for sender
              message percentage.
            </li>
          </ul>
        </>
