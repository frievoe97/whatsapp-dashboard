 ...
 * Jetzt wird davon ausgegangen, dass alle Nachrichten bereits vom Backend gefiltert sind.
 */
function aggregateSenderStats(
  ...
  // Temporäres Objekt zum Sammeln der Statistiken
  const stats: Record<
    string,
    {
      messageCount: number;
  ...
  // Umwandlung in ein Array – es findet keine Filterung nach Mindestanzahl statt
...
/**
 * Calculates the total height of an element (including margins).
 */
...
/* -------------------------------------------------------------------------- */
/*                     BarChartComp Component                     */
/* -------------------------------------------------------------------------- */

const BarChartComp: FC = () => {
  // Jetzt ausschließlich aus filteredMessages arbeiten
  ...
  // Aggregierte Statistiken berechnen – ohne minMessagePercentage-Filter
